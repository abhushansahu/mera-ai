...
class LangChainOrchestrator:
    ...
    def __post_init__(self) -> None:
        ...
        if self.coordinator is None:
            # Pass memory manager to coordinator (Chroma only now)
    ...
    @observe_langsmith(name="research_phase")
    ...
    @observe_langsmith(name="plan_phase")
    ...
    @observe_langsmith(name="implement_phase")
