...
class Settings(BaseSettings):
    ...
    per_message_model_enabled: bool = Field(default=True)
    obsidian_advanced_enabled: bool = Field(default=True)
    rpi_compact_layout_enabled: bool = Field(default=True)
    obsidian_event_sync_enabled: bool = Field(default=True)
